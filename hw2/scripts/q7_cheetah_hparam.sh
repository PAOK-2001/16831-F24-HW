...
#                 python rob831/scripts/run_hw2.py --env_name HalfCheetah-v4 --ep_len 150 --discount 0.95 -n 100 -l 2 -s 32 -b $B -lr $LR $RTG $NN_BASELINE --exp_name q7_b$B\_lr$LR$RTG$NN_BASELINE
#             done
#         done
#     done
# done
